"""Walk-forward evaluation for clinch_engine_improved.py.
...
Run in the repository root after copying clinch_engine_improved.py:
...
import clinch_engine_improved as m
